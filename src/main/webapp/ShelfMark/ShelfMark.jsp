...
<title>ShelfMark - http://bib.ld4l.org/ontology/ShelfMark</title>
<style type="text/css" media="all">    @import "/biblio/resources/style.css";</style></head>
<body>
<div id="content"><jsp:include page="/header.jsp" flush="true" /> <jsp:include page="/menu.jsp" flush="true"><jsp:param name="caller" value="research" /></jsp:include><div id="centerCol">
   <p><a href="altShelfMark.jsp?uri=${param.uri}">alternate view</a></p>
   <p><a href="../utility/sparqlDump.jsp?type=ShelfMark&uri=${param.uri}">RDF dump</a></p>
   <biblio:ShelfMark subjectURI="${param.uri}">

   <h3>Default Properties</h3>
   <table>
      <tr><td>URI</td><td><a href="<biblio:ShelfMarkSubjectURI/>"><biblio:ShelfMarkSubjectURI /></a></td></tr>
      <tr><td>Label</td><td><biblio:ShelfMarkLabel /></td></tr>
   </table>
