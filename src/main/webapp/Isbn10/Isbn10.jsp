...
<div id="content"><jsp:include page="/header.jsp" flush="true" /> <jsp:include page="/menu.jsp" flush="true"><jsp:param name="caller" value="research" /></jsp:include><div id="centerCol">
   ...
   <table>
      <biblio:foreachIsbn10IdentifiesIterator>
         <tr><td>identifies</td><td><a href="../<biblio:Isbn10IdentifiesType/>/<biblio:Isbn10IdentifiesType/>.jsp?uri=<biblio:Isbn10Identifies/>"><biblio:Isbn10Identifies /></a></td></tr>
      </biblio:foreachIsbn10IdentifiesIterator>
   </table>
   </biblio:Isbn10>
