...
<ul>
<biblio:foreachConcept limitCriteria="${limit}" offsetCriteria="${offset}" >
   <biblio:Concept>
      <li><a href="Concept.jsp?uri=<biblio:ConceptSubjectURI/>"><biblio:ConceptLabel/></a>
   </biblio:Concept>
</biblio:foreachConcept>
</ul>
